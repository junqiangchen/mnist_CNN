...
SOURCE_URL = 'E:\\vs2013workspace\shunyuyiqiProject\DeepLearing\\readmnist\MNIST_data/'
DATA_DIRECTORY = "data"
...
with tf.name_scope('weight'):
    ...
    xavier_weights = {
        ...
        'h2': tf.get_variable('w2_xaiver', [n_hidden_1, n_hidden_2],
                              initializer=tf.contrib.layers.xavier_initializer()),
        'out': tf.get_variable('wout_xaiver', [n_hidden_2, n_classes],
                               initializer=tf.contrib.layers.xavier_initializer())
    }
    he_weights = {
...
weight_initializer = {'normal': normal_weights, 'truncated_normal': truncated_normal_weights, 'xavier': xavier_weights,
                      'he': he_weights}
...
def main():
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            # and summary nodes
            _, train_accuracy, summary = sess.run([train_op_final, accuracy, merged_summary_op],
